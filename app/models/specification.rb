class Specification < ActiveRecord::Base
  ...
  has_many :features, class_name: "Feature", inverse_of: :specification, dependent: :destroy
  has_many :comparatives, class_name: "Comparative", inverse_of: :specification, dependent: :destroy
